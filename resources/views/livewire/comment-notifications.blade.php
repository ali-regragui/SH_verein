    ...
    >
                ...
                >
                    ...
                    <div class="ml-4">
                        <div class="line-clamp-6">
                            <span class="font-semibold">{{ $notification->data['user_name'] }}</span> Kommentiert den Beitrag von
        ...
        @else
            <li class="mx-auto w-40 py-6">
                ...
                <div class="text-gray-400 text-center font-bold mt-6">Keine Benachrichtigungen...</div>
            </li>
        @endif
    </ul>
</div>
