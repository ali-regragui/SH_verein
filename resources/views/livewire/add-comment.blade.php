...
>
    <button
        ...
        "
        class="flex items-center justify-center h-11 w-46 text-sm bg-violetC text-white font-semibold rounded-xl border border-violetC hover:bg-violet-hover transition duration-150 ease-in px-6 py-3"
    >
        Kommentar Schreiben
    </button>
    <div
    ...
    >
        @auth
            <form wire:submit.prevent="addComment" action="#" class="space-y-4 px-4 py-6">
                <div>
                    <textarea x-ref="comment" wire:model="comment" name="post_comment" id="post_comment" cols="30" rows="4" class="w-full text-sm bg-gray-100 rounded-xl placeholder-gray-900 border-none px-4 py-2" placeholder="Schreiben Sie ihr Kommentar" required></textarea>
                ...
                <div class="flex flex-col md:flex-row items-center md:space-x-3">
                    <button
                        type="submit"
                        class="flex items-center justify-center h-11 w-full md:w-1/2 text-sm bg-violetC text-white font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3"
                    >
                        Erstellen
                    </button>
                    {{-- <button
        ...
        @else
            <div class="px-4 py-6">
                <p class="font-normal">Loggen Sie sich ein, um einen einen Kommentar zu erstellen</p>
